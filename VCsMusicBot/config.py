...
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "mrk_yt")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "Mo_Tech_Group")
PROJECT_NAME = getenv("PROJECT_NAME", "VCsMusicBot")
SOURCE_CODE = getenv("SOURCE_CODE", "https://github.com/MRK-YT/MT-GroupMusic-Bot")
